...
public class SearchFlight extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(noofpersons != null)
		{
			String personsQuery = " and f.numberOfSeats >= " + noofpersons;
			query = query.concat(personsQuery);
		}
		if(date != null)
		{ 
			String dateQuery = " and f.dateOfDeparture = '" + date + "'";
		...
		if(flights.size() > 0)
		{
			...
			out.print("<h4><a href=\"index.html\">Back</a></h4>");
			out.println("<h2>List of flights</h2><br/>");
